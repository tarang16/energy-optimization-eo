...
export const YearlyView = ({ selectedPlants, caseId, dateRange }) => {
  ...
  return (
    <div className='h-100 w-100' data-static-id='YearlyView.js_div_aa0cb4'>
      {isLoading ? (
        <Loader />
      ) : (
        <>
          {chartData?.length > 0 ? (
            ...
            <div
              ...
              data-static-id='YearlyView.js_div_7e4fc9'
            >
              <p
                className='text-12-regular'
                data-static-id='YearlyView.js_p_a12971'
              >
                No Data found.....
              </p>
            </div>
