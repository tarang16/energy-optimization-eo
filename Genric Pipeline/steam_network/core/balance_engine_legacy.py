"""Legacy graph-topology balance engine (superseded by tag-driven balance_engine.py).

Kept so NetworkSolver keeps working with the demo network. Do not extend.
