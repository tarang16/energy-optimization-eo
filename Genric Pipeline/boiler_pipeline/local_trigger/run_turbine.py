...
from pipelines.turbine_calc.pipeline import TurbineCalcPipeline
...
def main():
    ...
    inputs_dir  = _HERE / "inputs_turbine"
    results_dir = _HERE / "results_turbine"
